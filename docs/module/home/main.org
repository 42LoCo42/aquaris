...
Set of strings, where every entry name is a (potentially nested) directory
beneath =~/.java/.userPrefs/=, in which a =prefs.xml=
containing the entry value is created.
