...
Inspired by [[https://github.com/nix-community/disko][disko]], but dissatisfied with its pretty verbose configuration,
...
LUKS-encrypted partitions and even ZFS pools and datasets.
LVM support is not currently planned, but will be added when it becomes neccessary.

With very compact semantics, default configurations
